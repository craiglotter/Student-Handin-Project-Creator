...
Public Class Worker
    ...
    Public novellserver As Boolean = False
    Public foldercount As Long = 0
        ...
        Try
            ...
            Select Case threadNumber
                Case 1
                    ...
                    ' Starts the thread.
                    WorkerThread.Start()
                    'MsgBox("ChooseThreads: Thread Should have started")
                Case 2
                    ' Sets the thread using the AddressOf the subroutine where
                    ' the thread will start.
                    foldercount = 0
    ...
    Public Function MapDrive(ByVal pathtomap As String) As String
        ...
        Try
            ...
            While runner.MoveNext() = True
                ...
                If letterlist.IndexOf(d.DriveLetter.ToString) <> -1 Then
            ...
            If continue1 = True Then
                ...
                Else
                    resultdrive = "Fail. Unable to map the given path to a directory"
                End If
            End If
        Catch ex As Exception
